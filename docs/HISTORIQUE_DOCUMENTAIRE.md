# Historique documentaire — première réalisation
...
Date : 2026-09-16 — Statut : superseded pour le pilotage, historique conservé.

Les indications « dernier état » ci-dessous sont historiques. Le [guide de reprise](archive/GUIDE_REPRISE.md) est archivé ; le point d’entrée actuel est le [rapport technique](../reports/RAPPORT_TECHNIQUE_POC.md).
...
- [Lecture pédagogique : comprendre les changements de méthode](learning/33-retour-sur-la-demarche-du-projet.md)
...
- [Apprentissage : comparer avant DPO](learning/28-comparer-avant-aligner.md)
- [Apprentissage : API et preuves](learning/29-relier-modele-api-et-preuves.md)
...
- [Apprentissage : auditer la pipeline](learning/30-auditer-la-pipeline-avant-entrainer.md)
...
- [Apprentissage : micro-run et recharge](learning/31-verifier-un-micro-run-et-sa-recharge.md)

## Préparation contrôlée du pilote SFT v2

- [Audit final des données et du trainer](evidence/SFT_V2_READINESS_2026-09-11.md)
- [Comprendre le nettoyage et le pilote](learning/32-donnees-propres-et-pilote-avant-sft.md)
...
- [Comprendre la précision numérique et l’évaluation](learning/34-evaluation-et-precision-numerique.md)

## Résultats du pilote borné

- [Résultats v19, progrès et régressions](evidence/SFT_V19_PILOT_RESULT_2026-09-11.md)
- [Comprendre la loss, le format et la qualité](learning/35-lire-le-pilote-sans-confondre-loss-et-qualite.md)
...
- [Mémorisation et généralisation](learning/36-memorisation-et-generalisation.md) — ce que cet essai peut prouver.
...
- [Comprendre la reprise](learning/37-reprendre-le-sft-sans-repartir-de-zero.md) — poids, optimiseur et scheduler.

- [Évaluation du SFT à 500 étapes](evidence/SFT_V22_RESULT_2026-09-12.md) — reprise vérifiée, résultats et limites.
- [Comprendre le résultat à 500 étapes](learning/38-comprendre-les-resultats-du-sft-a-500-etapes.md) — loss, arrêts et exactitude.
