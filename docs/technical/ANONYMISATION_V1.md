...
Le test automatisé utilise des chaînes synthétiques et des doubles de test. Une validation d'intégration avec les modèles spaCy sera enregistrée séparément lorsque les dépendances et modèles seront installés dans l'environnement du projet.
