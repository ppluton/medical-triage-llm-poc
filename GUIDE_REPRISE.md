...
**Prochaine action concrète : réaliser la nouvelle revue qualitative aveugle des sorties v37 gardées, puis décider si les défauts observés justifient un SFT ciblé.** L'optimisation v38/vLLM est différée : elle n'est plus sur le chemin critique. Aucun nouveau DPO n'est lancé tant qu'un défaut ciblé par les préférences n'est pas démontré.
