#!/usr/bin/env python3
"""Compare current Base/SFT/DPO on identical development inputs without training."""
...
def main():
    ...
    for stage in ("base", "sft", "dpo"):
        ...
        comparison[stage] = {
            ...
            "triage": score_outputs(scenarios, triage),
        }
    summary = {
        "status": "completed",
        "optimizer_steps": 0,
        ...
        "input_hashes": {
            ...
            for name in ("sft_manifest", "data_manifest", "validation", "prior_qa", "scenarios")
        },
