...
| API de démonstration cloud | [Recette vLLM](../docs/technical/VLLM_DEMONSTRATION_V1.md), [cible Modal v1](../docs/technical/MODAL_DEPLOYMENT_V1.md), [collecte](../docs/technical/COLLECTE_COMPLEMENTAIRE_V1.md) | Inférence locale sur GPU Kaggle prouvée et cible Modal préparée ; accès extérieur autorisé restant à établir |
| CI/CD | [CI](../.github/workflows/ci.yml), [CD Modal manuelle](../.github/workflows/deploy-modal.yml), [preuve locale](../docs/evidence/MODAL_DEPLOYMENT_PREPARATION_2026-09-16.md) | CI et définition CD vérifiées localement ; exécution GitHub et déploiement distant à prouver |
