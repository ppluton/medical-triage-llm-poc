...
| CI/CD | [CI](../.github/workflows/ci.yml), [CD Modal manuelle](../.github/workflows/deploy-modal.yml), [preuve GitHub](../docs/evidence/GITHUB_CI_MODAL_PREPARATION_2026-09-16.md) | CI distante tests/conteneur passée ; exécution de la CD et déploiement Modal à prouver |
