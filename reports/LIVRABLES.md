...
Le dataset et les adaptateurs finaux sont publiés sur Hugging Face ([dataset](https://huggingface.co/datasets/Pedro1321/chsa-triage-medical-qa-fr-en), [adaptateurs](https://huggingface.co/Pedro1321/chsa-triage-qwen3-1.7b-lora), [ADR-022](../docs/decisions/ADR-022-publier-dataset-et-adaptateurs-hugging-face.md)). Les journaux, sorties générées et fichiers de revue restent privés. Le dépôt GitHub ne contient ni token, ni données patient identifiantes, ni poids de modèle. Les fichiers de démonstration sont synthétiques. Les anciennes expériences restent dans `docs/evidence/` et `docs/evidence/archive/` pour la traçabilité et ne décrivent pas l'état courant.
